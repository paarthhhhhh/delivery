...
const navigate = useNavigate()
  ...
  return (
    <section className="w-full flex items-center justify-between p-4 bg-gradient-to-r from-gray-900 to-black text-gray-100">
      <div className="logo">
      <h1 className="text-2xl font-bold tracking-tighter">GROCERY<span className="text-gray-400">APP</span></h1>      </div>
      ...
      <div className="hidden md:flex anchor-links">
        <ul className="flex gap-6 text-xl items-center">
          <Link
            ...
            className={`text-sm uppercase tracking-wider hover:text-white transition duration-300 ${
              active === "Home"
