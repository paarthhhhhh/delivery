...
const Profile = () => {
  ...
  if (!profile) {
    return <div className='bg-gradient-to-r from-gray-900 to-black text-gray-100 text-8xl h-screen flex justify-center items-center' >404 Not Found ! <br />Please Sign Up First</div>;
  }
